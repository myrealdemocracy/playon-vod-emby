...
namespace PlayOn.Emby.Helper
{
    public class Channel
    {
        ...
        public static Task<ChannelItemResult> AllItems(InternalAllChannelMediaQuery query, CancellationToken cancellationToken)
        {
            return Items(new InternalChannelItemQuery(), cancellationToken);
        }
